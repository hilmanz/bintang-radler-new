...
class newsHelper{
	...
	function forgotpassword(){
		...
		if($qData){
			...
			$EMAIL['forgotpassword']['body'][0] ="Your BEAT Password Has Been Reset <br><br>";
			$EMAIL['forgotpassword']['body'][1] ="HI {$firstname} {$last_name},<br><br>";
			$EMAIL['forgotpassword']['body'][2] ="
					The password for your BEAT account has been successfully reset.<br> 
					We have included your reset password below.<br><br>					 
					You can login with this password and change it to something you'll remember.<br><br>";
			$EMAIL['forgotpassword']['body'][3] =" Password : ".$password;
			
			$msg = " 	{$EMAIL['forgotpassword']['body'][0]}
						{$EMAIL['forgotpassword']['body'][1]}
						{$EMAIL['forgotpassword']['body'][2]}
						{$EMAIL['forgotpassword']['body'][3]}
						";
