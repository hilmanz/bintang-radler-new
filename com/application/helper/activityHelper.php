...
class activityHelper {
	...
	function getnotificationuser($limit=10,$start=null){
		...
		$sql = " SELECT id,notification FROM my_notification WHERE userid={$this->uid} ORDER BY datetimes DESC LIMIT {$start},{$limit} ";
