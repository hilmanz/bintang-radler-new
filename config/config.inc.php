...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	...
	$DOMAIN = "http://localhost/bintang-radler-new/public_html/";

}

$CONFIG['BASE_DOMAIN_PATH'] = "http://localhost/bintang-radler-new/public_html/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/Applications/XAMPP/xamppfiles/htdocs/bintang-radler-new/public_html/";
...
if($local){
	...
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "subscribes_db";
