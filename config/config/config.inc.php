...
$CONFIG['radius'] = 50;
//WEB APP BASE DOMAIN
// echo ("preview.radlerdigital.com");localhost/
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/radler-new/public_html/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/radler-new/public_html/";
	$PUBLIC_HTML = "";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://{$_SERVER['HTTP_HOST']}/radler-new/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/kana/kanadigital/preview/radler-new/public_html/public_assets/";





$CONFIG['PUBLIC_ASSETS_DOMAIN_PATH'] = "localhost/radler-new/{$CONFIG['PUBLIC_ASSET']}";
$CONFIG['LOCAL_ASSET'] = "/home/kana/kanadigital/preview/radler-new/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "soursally_apps_2014";
...
$CONFIG['DATABASE_WEB'] = "subscribes_db";
 ...
 * Email settings
 */
$CONFIG['EMAIL_FROM_DEFAULT'] = "no-reply@bintangradler.co.id";
...
$CONFIG['supportemail']  = "support@bintang-readler.com";
